...
app = Flask(__name__)
client = MongoClient("mongodb://dice:dice4@ac-873sgcf-shard-00-00.dspgaoc.mongodb.net:27017,ac-873sgcf-shard-00-01.dspgaoc.mongodb.net:27017,ac-873sgcf-shard-00-02.dspgaoc.mongodb.net:27017/?ssl=true&replicaSet=atlas-jb0heg-shard-0&authSource=admin&retryWrites=true&w=majority", tlsCAFile=ca)
